...
*/
    ...
    $css_files = array(
        ...
        // "assets/css/apps.all.css",
        "assets/css/app-new.all.css",
    ...
    load_js(array(
        "assets/js/typeahead-js/typeahead.js"
    ));
    

    //load_js(array("assets/js/app.js"));


    /**********************************/

    load_js(array("assets/js/odai-app.js"));
    load_js(array("assets/bootstrap-timepicker.js"));
