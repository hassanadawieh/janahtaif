<div id="page-content" class="page-wrapper clearfix">
    <div class="clearfix">
        <ul id="client-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
            ...
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("clients/projects/"); ?>" data-bs-target="#projects"><?php echo app_lang('projects'); ?></a></li>
        ...
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane fade" id="projects"></div>
        </div>
    </div>
</div>
    ...
    $(document).ready(function () {
        setTimeout(function () {
            ...
            if (tab === "clients_list" || tab === "clients_list-has_open_projects") {
                ...
                $("[data-bs-target='#projects']").trigger("click");
