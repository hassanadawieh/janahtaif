        ...
        $searchBox.on('awesomplete-selectcomplete', function () {
            ...
            if (this.value) {
                var location = "",
                    ...
                    if (searchFieldValue === "main_task") {
                        location = "<?php echo get_uri("tasks/task_view"); ?>/" + this.value;
                    } else if (searchFieldValue === "subtasks") {
                        location = "<?php echo get_uri("subtasks/task_view"); ?>/" + this.value;
