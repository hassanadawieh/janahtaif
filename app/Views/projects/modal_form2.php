...
<div class="modal-body clearfix">
        ...
        <div class="form-group">
            <div class="row">
                <label for="client_id" class=" col-md-3"><?php echo app_lang('client'); ?></label>
                    <div class=" col-md-9">
                        <?php
                        echo form_dropdown("client_id", $clients_dropdown, array($client_id), "class='select2 validate-hidden' id='client_id' data-rule-required='true', data-msg-required='" . app_lang('field_required') . "'");
                        ?>
                    </div>
            </div>
        </div>
    <?php }   ?>
        ...
        <div class="form-group">
            <div class="row">
                <label for="title_en" class=" col-md-3"><?php echo app_lang('title'); ?> الاجنبي</label>
                <div class=" col-md-9">
                    <?php
                    echo form_input(array(
                        "id" => "title_en",
