    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-lg-10">
            <div class="row">
                ...
                <div class="col-md-8">
                    <div id="role-details-section"  style="min-height: 1000px;"> 
                        <div id="empty-role" class="text-center p15 box card " id="my_card" style="min-height: 150px;">
...
<script type="text/javascript">
    ...
    window.onload = function() {
        //alert($(window).height());
    $('#role-details-section').css({"min-height": ($(window).height()) + "px"});
