<div class="card mb0">
    <div class="tab-title clearfix">
        ...
        <div class="title-button-group">
            ...
            if ($can_create_tasks) {
                echo modal_anchor(get_uri("tasks/task_modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_multiple_tasks'), array("class" => "btn btn-default", "title" => app_lang('add_multiple_tasks'), "data-post-project_id" => $supplier_id, "data-post-add_type" => "multiple"));
                echo modal_anchor(get_uri("tasks/task_modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_task'), array("class" => "btn btn-default", "title" => app_lang('add_task'), "data-post-project_id" => $supplier_id));
            }
            ?>
        </div>
    </div>
...
<?php } ?>
        ...
        $("#kanban-filters").appFilters({
            source: '<?php echo_uri("tasks/project_tasks_kanban_data/" . $supplier_id) ?>',
