        ...
        <div class="tab-title clearfix no-border">
            <div class="title-button-group">
                ...
                if ($can_create_tasks) {
                    ...
                    echo modal_anchor(get_uri("tasks/task_modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_task'), array("class" => "btn btn-default", "title" => app_lang('add_task')));
                }
                ?>
            </div>
        </div>
