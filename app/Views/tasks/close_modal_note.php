<?php echo form_open(get_uri("tasks/save_status"), array("id" => "update_task-form", "class" => "general-form", "role" => "form")); ?>
...
<div id="tasks-dropzone" class="post-dropzone">
    ...
    <div class="modal-footer">
        <div id="link-of-new-view" class="hide">
            <?php
            echo modal_anchor(get_uri("tasks/task_view"), "", array("data-modal-lg" => "1"));
            ?>
        </div>
