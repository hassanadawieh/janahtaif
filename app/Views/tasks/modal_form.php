...
<div id="tasks-dropzone" class="post-dropzone">
    <div class="modal-body clearfix">
        <div class="container-fluid">
            ...
            <?php if (!empty($model_info->created_date) && $model_info->created_date != '0000-00-00') { ?>
                <input type="hidden" id="created_date" name="created_date" value="<?php echo is_date_exists($model_info->created_date) ? $model_info->created_date : $dateTime->format('d/m/Y'); ?>">
            <?php } ?>
            <input type="hidden" name="add_type" value="<?php echo $add_type; ?>" />

            <?php if (!$is_admin) { ?>
                <?php if (!empty($model_info->client_id)) { ?>
                    <input type="hidden" id="client_id" name="client_id" value="<?php echo $add_type == "multiple" ? 0 : $model_info->client_id; ?>">
                <?php } ?>
                <?php if (!empty($model_info->client_contact_id)) { ?>
                    <!-- <input type="hidden" id="contact_id" name="contact_id" value="<?php //echo  $add_type != "multiple" ? $model_info->client_contact_id : ''; ?>"> -->
                    <?php                                                            
                    echo form_input(array(
                    "type" => "hidden",
                    "name" => "contact_id", // الحقل المخفي الذي سيرسل القيمة
                    "value" => $add_type != "multiple" ? $model_info->client_contact_id : '',
                    )); 
                    ?>
                <?php } ?>
                <?php if (!empty($model_info->project_id)) { ?>
                    <!-- <input type="hidden" id="project_id" name="project_id" value="<?php //echo $add_type != "multiple" ? $model_info->project_id : ''; ?>"> -->
                            <?php                                                            
                    echo form_input(array(
                    "type" => "hidden",
                    "name" => "project_id", // الحقل المخفي الذي سيرسل القيمة
                    "value" => $add_type != "multiple" ? $model_info->project_id : '',
                    )); 
                    ?>
                <?php } ?>
                <?php if (!empty($model_info->cls_id)) { ?>
                    <input type="hidden" id="cls_id" name="cls_id" value="<?php echo $add_type != "multiple" ? $model_info->cls_id : ''; ?>">
                <?php } ?>
                <?php if (!empty($model_info->ref_number)) { ?>
                    <input type="hidden" id="ref_number" name="ref_number" value="<?php echo $model_info->ref_number ? $model_info->ref_number : ''; ?>">
                <?php } ?>
            <?php } ?>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <?php
                        $disabled_client_id = $is_admin ? "" : (!empty($model_info->client_id) ? "disabled" : "");
                        echo form_dropdown("client_id", $clients_dropdown, array($add_type == "multiple" ? 0 : $model_info->client_id), "class='select2 validate-hidden' id='client_id' $disabled_client_id data-rule-required='true', data-msg-required='" . app_lang('field_required') . "'");
                        ?>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-10" id="dropdown-apploader-section">
                        <?php
                        $disabled_client_contact_id = $is_admin ? "" : (!empty($model_info->client_contact_id) ? "disabled" : "");
                        echo form_input(array(
                            "id" => "contact_id",
                            "name" => "contact_id",
                            "value" => $add_type != "multiple" ? $model_info->client_contact_id : '',
                            ...
                            $disabled_client_contact_id => $disabled_client_contact_id
                        ));
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-10" id="dropdown-apploader-section">
                        <?php
                        $disabled_project_id = $is_admin ? "" : (!empty($model_info->project_id) ? "disabled" : "");
                        echo form_dropdown(array(
                            ...
                            $disabled_project_id => $disabled_project_id,
                        ));
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <?php
                        $disabled_cls_id = $is_admin ? "" : (!empty($model_info->cls_id) ? "disabled" : "");
                        ...
                        ?>
                        <?php
                        echo form_dropdown("cls_id", $maintask_clsifications_dropdown, array($my_cls_id), "class='select2 validate-hidden' id='cls_id' $disabled_cls_id ");
                        ?>
                    </div>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <?php
                        $disabled_ref_number = $is_admin ? "" : (!empty($model_info->ref_number) ? "disabled" : "");
                        echo form_input(array(
                            "id" => "ref_number",
                            "name" => "ref_number",
                            "value" =>  $model_info->ref_number ? $model_info->ref_number : '',
                            "class" => "form-control",
                            $disabled_ref_number => $disabled_ref_number,
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class=" col-md-10">
                        ...
                        $isDisabledDate = (empty($model_info->created_date) || $model_info->created_date == '0000-00-00') ? "" : "disabled";
    ...
    $(document).ready(function() {
        ...
        window.taskForm = $("#task-form").appForm({
            ...
            onSuccess: function(result) {
                ...
                window.location.replace("<?php //echo get_uri("subtasks/index/"); 
                                            ?>"+result.id+"/tasks_list/0/yes");
