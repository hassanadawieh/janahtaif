...
<script type="text/javascript">
    $(document).ready(function () {
        $('body').on('click', '[data-act=update-task-info]', function (e) {
            ...
            } else if (type === "created_date" || type === "deadline") {
                editableType = "date";
...
<?php if (is_date_exists($model_info->out_date)) { ?>
                        datepicker["startDate"] = "<?php echo format_to_date($model_info->out_date); ?>";
<?php } ?>
                }
            ...
            $(this).appModifier({
                ...
                actionUrl: '<?php echo_uri("projectsdd/update_task_info") ?>/' + $(this).attr('data-id') + '/' + $(this).attr('data-act-type'),
                ...
                onSuccess: function (response, newValue) {
                    if (response.success) {
                        ...
                        if ((type === "created_date" || type === "deadline") && response.date) {
                            setTimeout(function () {
