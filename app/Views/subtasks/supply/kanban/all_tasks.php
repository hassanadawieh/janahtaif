<div id="page-content" class="page-wrapper pb0 clearfix">
    ...
    <ul class="nav nav-tabs bg-white title" role="tablist" style="padding-right: 10px;">
        <li class="title-tab"><h4 class="pl15 pt10 pr15"><?php echo app_lang("sub_tasks").' - '.app_lang("supply_mang"); ?></h4></li>
        ...
        <div class="tab-title clearfix no-border">
            <div class="title-button-group">
                ...
                if ($can_create_tasks) {
                    echo modal_anchor(get_uri("subtasks/task_modal_form_supply"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_multiple_tasks'), array("class" => "btn btn-default", "title" => app_lang('add_multiple_tasks'), "data-post-add_type" => "multiple"));
                    echo modal_anchor(get_uri("subtasks/task_modal_form_supply"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_task'), array("class" => "btn btn-default", "title" => app_lang('add_task')));
                }*/
                ?>
            </div>
        </div>
...
<?php echo view("subtasks/supply/kanban/all_tasks_kanban_helper_js"); ?>
