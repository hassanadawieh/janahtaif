   ...
   <div class="container-fluid">
      ...
      <div class="form-group">
         <div class="row">
            ...
            ?>
            <!--<label for="status_id" class=" col-md-2"><?php //echo app_lang('status'); 
                                                         ?></label>-->
            <!--</div>-->
            <?php //} 
            ?>
      ...
      <div class="row" style="padding-right: 5px; padding-left: 5px;">
         ...
         <div class="col-md-4 mb5 mt5 text-wrap">
            ...
            <label><?php $act_out_time_txt = date_create($model_info->act_out_time);
                     echo $model_info->act_out_time && $model_info->act_out_time != '00:00:01' ? date_format($act_out_time_txt, "h:i A") : '___'; ?></label>
         </div>
         <div class="col-md-4 mb5 mt5 text-wrap">
      ...
      $(document).ready(function() {
         ...
         window.taskForm = $("#task-form").appForm({
            ...
            onSuccess: function(result) {
               ...
               try {
                  $("#mytask-table_" + result.pnt_id).appTable({
                     newData: result.data,
                     dataId: result.id
                  });
         ...
         $currentDate = $dateTime20->format(get_setting("date_format"));      ?>
         var we = '<?php echo $ddt; ?>';
         ...
         $('#tmp_return_date').datepicker('setStartDate', '' + be + '');
          ...
          $('#sales_act_return_date').datepicker('setEndDate', ''+endDate+'');
         ...
         $('#priority_id').select2({
            data: <?php echo json_encode($priorities_dropdown); ?>
         });
      });
   </script>
