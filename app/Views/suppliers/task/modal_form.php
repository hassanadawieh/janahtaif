    ...
    <div class="modal-body clearfix">
        <div class="container-fluid">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                <div class="row">
                    <label for="contact_id" class=" col-md-3"><?php echo app_lang('contacts'); ?></label>
            ...
            <div class="form-group">
                <div class="row">
                    <label for="title" class=" col-md-3"><?php echo app_lang('supplier'); ?></label>
                    <div class=" col-md-9">
                        <?php
                        echo form_input(array(
                            "id" => "supplier_id",
            ...
            onSuccess: function (result) {
                ...
                if (window.showAddNewModal) {
                    ...
                    if (addType === "multiple") {
                        ...
                        $taskViewLink.attr("data-post-supplier_id", "<?php echo $supplier->id; ?>");
