    ...
    <div class="card rounded-bottom">
        <div class="tab-title clearfix">
            ...
            <div class="title-button-group">
                <?php
                if ($can_edit_clients) {
                    echo modal_anchor(get_uri("suppliers/invitation_modal"), "<i data-feather='mail' class='icon-16'></i> " . app_lang('send_invitation'), array("class" => "btn btn-default", "title" => app_lang('send_invitation'), "data-post-client_id" => $client_id));

                    echo modal_anchor(get_uri("suppliers/add_new_contact_modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_contact'), array("class" => "btn btn-default", "title" => app_lang('add_contact'), "data-post-client_id" => $client_id));
                }
                ?>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var quick_filters_dropdown = <?php echo view("suppliers/contacts/quick_filters_dropdown"); ?>;
        ...
        $("#contact-table").appTable({
            ...
            columns: [
                ...
                {visible: showCompanyName, title: "<?php echo app_lang("supplier_name") ?>", "class": "w150", order_by: "name"},
