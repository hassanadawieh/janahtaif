...
if (!function_exists("get_update_task_info_anchor_data")) {
    ...
    function get_update_task_info_anchor_data($model_info, $type = "", $can_edit_tasks = false, $extra_data = "", $extra_condition = false) {
        if ($model_info && $type) {
            ...
            $created_date = "<span class='text-off'>" . app_lang("add") . " " . app_lang("task_date") . "<span>";
            if ($model_info->created_date) {
                $created_date = format_to_date($model_info->created_date, false);
            }
            ...
            if ($type == "is_closed") {
                ...
                return $can_edit_tasks ? js_anchor($model_info->is_closed==1 ? app_lang('open') : app_lang('closed'), array('title' => "", "class" => "white-link", "data-id" => $model_info->id, "data-value" => $model_info->is_closed, "data-act" => "update-task-info", "data-act-type" => "is_closed")) : ($model_info->is_closed==1 ? app_lang('open') : app_lang('closed'));
                ...
                return $can_edit_tasks ? js_anchor($model_info->supplier_name ? $model_info->supplier_name : "<span class='text-off'>" . app_lang("add") . " " . app_lang("supplier") . "<span>", array('title' => "", "class" => "", "data-id" => $model_info->id, "data-value" => $model_info->supplier_id, "data-act" => "update-task-info", "data-act-type" => "supplier_id")) : $model_info->supplier_name;

            } else if ($type == "cls_id") {

                return $can_edit_tasks ? js_anchor($model_info->cls_title ? $model_info->cls_title : "<span class='text-off'>" . app_lang("cls_add") ."<span>", array('title' => "", "class" => "", "data-id" => $model_info->id, "data-value" => $model_info->cls_id, "data-act" => "update-task-info", "data-act-type" => "cls_id")) : $model_info->cls_title;

            } else if ($type == "client") {

                return $can_edit_tasks ? js_anchor($model_info->company_name ? $model_info->company_name : "<span class='text-off'>" . app_lang("add") . " " . app_lang("client") . "<span>", array('title' => "", "class" => "", "data-id" => $model_info->id, "data-value" => $model_info->client_id, "data-act" => "update-task-info", "data-act-type" => "client_id")) : $model_info->company_name;
                ...
                return $can_edit_tasks ? js_anchor($created_date, array('title' => "", "class" => "", "data-id" => $model_info->id, "data-value" => $model_info->created_date, "data-act" => "update-task-info", "data-act-type" => "created_date")) : format_to_date($model_info->created_date, false);
