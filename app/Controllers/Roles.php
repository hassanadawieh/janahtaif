...
class Roles extends Security_Controller {
    ...
    function permissions($role_id) {
        if ($role_id) {
            ...
            $view_data['supplier_permission'] = get_array_value($permissions, "supplier_permission");
            $view_data['drivers_permission'] = get_array_value($permissions, "drivers_permission");
            $view_data['car_type_permission'] = get_array_value($permissions, "car_type_permission");
            ...
            $view_data['can_edit_only_own_subtasks'] = get_array_value($permissions, "can_edit_only_own_subtasks");
            ...
            $view_data['can_edit_subtasks_after_closed'] = get_array_value($permissions, "can_edit_subtasks_after_closed");
            $view_data['can_edit_subtasks_after_review'] = get_array_value($permissions, "can_edit_subtasks_after_review");
            ...
            $view_data['can_show_tasks'] = get_array_value($permissions, "can_show_tasks");

            $view_data['can_create_subtasks'] = get_array_value($permissions, "can_create_subtasks");
            $view_data['can_edit_subtasks'] = get_array_value($permissions, "can_edit_subtasks");
            $view_data['can_show_subtasks'] = get_array_value($permissions, "can_show_subtasks");
            $view_data['can_delete_subtasks'] = get_array_value($permissions, "can_delete_subtasks");

            $view_data['can_add_suppliers'] = get_array_value($permissions, "can_add_suppliers");
            ...
            $view_data['reserv_mang'] = get_array_value($permissions, "reserv_mang");


            $view_data['can_edit_own_tasks'] = get_array_value($permissions, "can_edit_own_tasks");
            $view_data['can_delete_tasks'] = get_array_value($permissions, "can_delete_tasks");
            $view_data['can_update_maintask_status'] = get_array_value($permissions, "can_update_maintask_status");
            $view_data['can_show_subtasks_report'] = get_array_value($permissions, "can_show_subtasks_report");
            $view_data['can_update_maintask_after_closed'] = get_array_value($permissions, "can_update_maintask_after_closed");

            $view_data['can_update_subtask_status'] = get_array_value($permissions, "can_update_subtask_status");
    ...
    function save_permissions() {
        ...
        $can_edit_own_tasks = $this->request->getPost('can_edit_own_tasks');
        $can_delete_tasks = $this->request->getPost('can_delete_tasks');
        $can_update_maintask_status = $this->request->getPost('can_update_maintask_status');
        $can_show_subtasks_report = $this->request->getPost('can_show_subtasks_report');
        $can_update_maintask_after_closed = $this->request->getPost('can_update_maintask_after_closed');
        $can_update_subtask_status = $this->request->getPost('can_update_subtask_status');
        ...
        $permissions = array(
            ...
            "drivers_permission" => $drivers_permission,
            "car_type_permission" => $car_type_permission,
            ...
            "can_edit_only_own_subtasks" => $can_edit_only_own_subtasks,
            ...
            "can_edit_subtasks_after_closed" => $can_edit_subtasks_after_closed,
            "can_edit_subtasks_after_review" => $can_edit_subtasks_after_review,
            "can_edit_tasks" => $can_edit_tasks,
            "can_show_tasks" => $can_show_tasks,

            "can_create_subtasks" => $can_create_subtasks,
            "can_edit_subtasks" => $can_edit_subtasks,
            "can_show_subtasks" => $can_show_subtasks,
            "can_delete_subtasks" => $can_delete_subtasks,
            ...
            "reserv_mang" => $reserv_mang,

            
            "can_edit_own_tasks" => $can_edit_own_tasks,
            "can_delete_tasks" => $can_delete_tasks,
            "can_update_maintask_status" => $can_update_maintask_status,
            "can_show_subtasks_report" => $can_show_subtasks_report,
            "can_update_maintask_after_closed" => $can_update_maintask_after_closed,
            "can_update_subtask_status" => $can_update_subtask_status,
