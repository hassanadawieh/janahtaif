...
class Projects_model extends Crud_model {
    ...
    function get_details($options = array()) {
        ...
        $sql = "SELECT $projects_table.* , $clients.company_name AS company_name, CONCAT($users_table.first_name, ' ',$users_table.last_name) AS user_name
        FROM $projects_table
        LEFT JOIN $users_table ON $users_table.id=$projects_table.created_by
    ...
    function get_gantt_data($options = array()) {
        ...
        $sql = "SELECT $tasks_table.id AS task_id, $tasks_table.title AS task_title, $tasks_table.status_id, $tasks_table.start_date, $tasks_table.deadline AS end_date, $tasks_table.parent_task_id, $tasks_table.assigned_to, CONCAT($users_table.first_name, ' ', $users_table.last_name ) AS assigned_to_name, $tasks_table.project_id, CONCAT($projects_table.title) AS project_name,
